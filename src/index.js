...
function Menu(){
    ...
    return (
        <main className="menu">
            <h2>Our Menu</h2>
            <Pizza name="pizza proscuitto" ingredients="Tomato, mozarella, ham, aragula, and burrata cheese"
            photoName="pizzas/prosciutto.jpg" price={10} />

            <Pizza name='Pizza Funghi' ingredients='Tomato, mozarella, mushrooms, and onion' 
            photoName='pizzas/funghi.jpg'price={12}></Pizza>
        </main>
    )
...
function Footer(){
    ...
    // if (hour >= openHour && hour <= closeHour ) alert('We are open for business!')
